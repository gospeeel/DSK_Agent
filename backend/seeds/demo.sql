...
INSERT INTO apartments (id, building_id, number, rooms, floor, area, price, type_finishing, status) VALUES
    ...
    -- ЖК Левобережный, д. 215/1 (ID: 2104)
    ...
    -- ЖК Левобережный, д. 215/2 (ID: 2105)
