-- Preserve the selected ancillary-unit prices in every commercial-offer version.
-- The snapshot keeps an approved PDF stable when catalog prices change later.
