-- Forward-only reconciliation for databases that already applied the former
-- 000001-000006 migration sequence. Never rewrite an applied migration to add fields.
