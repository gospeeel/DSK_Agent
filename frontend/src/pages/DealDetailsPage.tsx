...
export const DealDetailsPage: React.FC = () => {
  ...
  // Load PDF preview when approved offer is available
  useEffect(() => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {/* Main 2-Column Grid: Left = Input/Config, Right = PDF & Summary */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        
        {/* Left Column: Data Input & Configuration (6 cols) */}
        <div className="lg:col-span-6 space-y-6">
          ...
          {/* Ancillary Units Selection & Discount */}
        ...
        {/* Right Column: PDF Preview & Calculations Summary (6 cols) */}
        <div className="lg:col-span-6 space-y-6">
          ...
          {/* PDF Document Preview / Live Container */}
          <div className="bg-white rounded-3xl border-2 border-zinc-900 p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-zinc-200 pb-3">
              <div className="flex items-center gap-2">
