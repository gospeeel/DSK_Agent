...
class ClientFacts(BaseModel):
    ...
    # Every key is required in structured LLM output. Unknown scalar values are
    # represented by null and unknown collections by [], rather than silently
    # filled from model defaults after GigaChat returns an incomplete object.
